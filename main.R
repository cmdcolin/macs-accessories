...
hs959z<-sapply(Zhs959,function(x){mean(x[,2])})
...
plot(s96z,hs959z,pch='*',xlab='Avg S96 peak normdiff',ylab='Avg HS959 syntenic normdiff',xlim=c(0.8,4),ylim=c(-0.5,3))
points(s96z[id1],hs959z[id1],col='yellow')
points(s96z[id2],hs959z[id2],col='blue')
...
hs959zdos<-sapply(Zhs959,function(x){mean(x[,2])})

plot(hs959zdos,s96zdos,pch='*',xlab='Avg S96 peak normdiff',ylab='hs959 syntenic')
points(hs959zdos[id3],s96zdos[id3],col='lightbrown')
points(hs959zdos[id4],s96zdos[id4],col='blue')
title('S96 peaks average NormDiff vs HS959 synteny')
plot(hs959zdos,s96zdos,pch='*',xlab='Avg S96 peak normdiff',ylab='Avg HS959 syntenic normdiff',xlim=c(0.8,4),ylim=c(-0.5,3))
points(hs959zdos[id3],s96zdos[id3],col='lightbrown')
points(hs959zdos[id4],s96zdos[id4],col='blue')
