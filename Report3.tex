...
'variable binding regions' across different experiments. We use statistical
comparison of normalized difference score to find conserved binding
sites. We also use the DNA alignment from different genomes in order
to classify binding sites. 
\end{abstract}
