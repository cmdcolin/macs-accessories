...
is important for analyzing ChIP-seq also. ChIP-seq experiments are
subject to many variables including noise, bias, and normalization
issues (Shao et al. 2012). 
\begin{enumerate}
...
tag counts that are identified from shared binding sites. 
