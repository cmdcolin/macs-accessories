...
Techniques like chromatin immunoprecipitation and high throughput
sequencing (ChIP-seq) can be used to analyze transcription factor
binding sites using . Zheng et al. characterized genetic differences
...
We used the normalized difference score to find conserved binding
regions multiple chip-seq experiments. We also evaluated other methods
for ChIP-seq data analysis for finding conserved binding sites and
variable binding sites, and how we can correlate binding site differences
with genome features.
\end{abstract}
