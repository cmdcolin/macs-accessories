...
x1<-read.table('S96rep1_normdiff_old.txt')

x1c1=x1[x1[,2]=="chr01",]
plot(x1c1[,3],x1c1[,5],type="l")



x2<-read.table('S96rep2_normdiff_old.txt',skip=1)
...
match=findInterval(x1c1[,3],x2c1[,3])
