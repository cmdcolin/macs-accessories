...
If we sort the values then we can get an idea of the cutoff that exists

<<Q4,echo=FALSE, out.width='.49\\linewidth'>>=
plotSortedMaxAvgZscore('Sorted HS959 Avg Normdiff in S96 peak regions',wig1,wig2,r3,r4,'red','blue')
plotSortedMaxAvgZscore('Sorted S96 Avg Normdiff in HS959 peak regions',wig2,wig1,r4,r3,'green','blue')
plotSortedMaxAvgZscore('Sorted HS959 Max Avg Normdiff in S96 peak regions',wig1,wig2,r1,r2,'red','blue')
plotSortedMaxAvgZscore('Sorted S96 Max Avg Normdiff in HS959 peak regions',wig2,wig1,r2,r1,'green','blue') 
@
\end{document}
