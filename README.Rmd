...
```{r sorted, dev='png'}
plotSortedMaxAvgZscore('Sorted HS959 Max Avg Normdiff connected with S96 peak regions',wig1,wig2,r1,'#00119919','#bb000019','#001199','#aa0000')  
plotSortedMaxAvgZscore('Sorted S96 Max Avg Normdiff connected with HS959 peak regions',wig2,wig1,r2,'#00990019','#bb000019','#009900','#aa0000')
```
...
```{r rainbow, dev='png',warning=FALSE}

plotMaxAvgZscoreColor('S96 vs HS959 peaks colored by probability',wig1,wig2,wz1,wz2)
plotMaxAvgZscoreColor('HS959 vs S96 peaks colored by probability',wig2,wig1,wz2,wz1)
```
